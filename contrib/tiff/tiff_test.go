...
import (
	"github.com/SergioPro123/gofpdfv2/contrib/tiff"
...
func ExampleRegisterFile() {
	...
	pdf.AddPageFormat("L", gofpdfv2.SizeType{Wd: 200, Ht: 200})
	opt := gofpdfv2.ImageOptions{ImageType: "tiff", ReadDpi: false}
